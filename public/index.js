...
document.addEventListener("DOMContentLoaded", function () {
    ...
    menuIcon.addEventListener('click', function () {
        ...
        // Update brand link content based on sidebar visibility
        if (sidebar.classList.contains('hide')) {
            // Sidebar is hidden, show fire extinguisher icon
            brandLink.innerHTML = '<span class="text1"><i class="fas fa-fire-extinguisher" style="margin-left: 5px;"></i></span>';
        } else {
            // Sidebar is visible, show system name
            brandLink.innerHTML = '<span class="text1">Fire<i class="fas fa-fire-extinguisher"></i> Extinguisher <p style="font-size:10px"> Mapping & Monitoring System</p></span>';
        }
    });
})
